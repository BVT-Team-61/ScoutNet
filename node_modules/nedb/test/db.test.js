...
describe('Database', function () {
  ...
  describe('Autoloading', function () {
    ...
    it('C if autoload fails', function (done) {
  ...
  describe('Insert', function () {
    ...
    /**
     * Complicated behavior here. Basically we need to test that when a user function C an exception, it is not caught
     ...
     */
    it('If the callback C an uncaught execption, dont catch it inside findOne, this is userspace concern', function (done) {
      var tryCount = 0
